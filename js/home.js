...
const CAT_CONFIG = {
  horse:      { tag: 'tag-racing',  label: 'Horse Racing', accent: '#CD73AD', image: '/assets/images/sport-horse.png' },
  ...
  mlb:        { tag: 'tag-mlb',     label: 'MLB',          accent: '#D9BEDB', image: '/assets/images/sport-mlb.png'   },
  ufc:        { tag: 'tag-ufc',     label: 'UFC',          accent: '#E87840', image: '/assets/images/sport-ufc.png'   },
};
